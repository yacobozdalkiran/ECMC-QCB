...
namespace mpi::heatbathcb {
    ...
    std::vector<double> samples(GaugeField &field, const GeometryCB &geo, MpiTopology &topo, const HbParams &params, std::vector<std::mt19937_64> &rng, parity active_parity);
}
